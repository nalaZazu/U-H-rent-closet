		...
		<div class="row mt-20">
			<div class="col-md-5">
				<div class="single-product-slider">
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						...
						<?php $img=explode(',', $row['picsource'] ); $x=1;
						 foreach ($img as $pic):?>
                            <div class='item <?=$x==1 ? "active":""?>'>
								<img src='<?php echo "dist/picture/".$pic;?>' alt='' data-zoom-image="images/shop/single-products/n-1-1.jpeg" />
							</div>
                        <?php $x++; endforeach; ?>			
							</div>
							<!-- sag sol -->
						...
						<ol class='carousel-indicators mCustomScrollbar meartlab'>
							<?php  $x=0;  foreach ($img as $pic): ?>
							<li data-target='#carousel-custom' data-slide-to='<?=$x?>' class='active'>
								<img src='<?php echo "dist/picture/".$pic;?>' alt='' />
							</li>
                        <?php $x++; endforeach ?>	
						</ol>
					</div>
			...
			<div class="col-md-7">
				<div class="single-product-details">
					...
					<h2><?=$row['title']?></h2>
					<h4>Price</h4>
					<p class="product-price">PKR <?=$row['price']?></p>
					...
					<a href="add-cart.php?id=<?=$row['id']?>" value="add-item"class="btn btn-main mt-20">Add to Cart</a>
				</div>
			</div>
		</div>
		<div class="row">
