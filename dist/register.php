...
<html lang="en">
    <head>
        ...
        <title>Register -U&h Admin</title>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form  action="admin_login.php" method="POST">
                                            ...
                                            <div class="form-group mt-4 mb-0"><button type="submit" class="btn btn-primary btn-block" name="submit">Create Account</button>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted"><span>Copyright @2021 U&H Rent Closet All Rights Reserved</span></div>
                            <div>
